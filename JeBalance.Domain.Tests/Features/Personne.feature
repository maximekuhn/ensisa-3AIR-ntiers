...
#        Then la personne est ajoutee a la liste des infotmateurs
#
...
#        Given un informateur soumet une dénonciation impliquant un membre VIP
#        Then l informateur est automatiquement ajouté a la liste des calomniateurs
